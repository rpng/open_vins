...
void VioManager::feed_measurement_imu(const ov_core::ImuData &message) {
  ...
  size_t num_unique_cameras = params.state_options.num_unique_cameras >= 1 ? params.state_options.num_unique_cameras : ((params.state_options.num_cameras == 2 && params.use_stereo) ? 1 : params.state_options.num_cameras);
